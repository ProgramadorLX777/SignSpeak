...
print("Reconociendo señas... (Presione ESC para salir)")
...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        for lm in mano.landmark:
            ...
            current_landmarks.append((nx, ny, nz))

        # Padding si faltan elementos (seguridad)
        while len(datos) < 126:
            datos.append(0.0)
    ...
    cv2.imshow("Reconocimiento Estatico - Presione ESC para Salir!!", frame)
